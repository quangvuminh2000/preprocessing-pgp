...
class EmailCleaner:
    ...
    def _remove_spaces(self, email: str) -> str:
        """
...
def clean_email(data: pd.DataFrame, email_col: str = "email") -> pd.DataFrame:
    """
    ...
    cleaned_data[f"cleaned_{email_col}"] = cleaned_data[email_col].apply(
        cleaner.clean_email
    )
