...
class EmailAddressExtractor:
    ...
    def __generate_norm_dict(self):
        ...
        # * Additional cities
        self.location_norm_dict["vungtau"] = self.location_norm_dict[
            "bariavungtau"
        ]
        self.location_norm_dict["baria"] = self.location_norm_dict[
            "bariavungtau"
        ]
    ...
    def extract_address(
        ...
        data["address_extracted"] = data[email_name_col].apply(
            self._get_address
        )
