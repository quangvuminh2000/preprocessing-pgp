...
if __name__ == '__main__':
    ...
    # path
    INPUT_PATH = ROOT_PATH + '/crossfill/profile_fshop.parquet'
    SAVE_PATH = ROOT_PATH + '/fillna/profile_fshop.parquet'
    
    # pipeline fillna 
    fillna_pipeline(spark, date, input_path=INPUT_PATH, save_path=SAVE_PATH, id_cttv='cardcode_fshop')
    
    # post processing
    post_processing(spark, date, path=SAVE_PATH, cttv='FSHOP')
