...
def UnifyFtel(profile_ftel, date_str='2022-07-01'):
    ...
    # clean name
    condition_name = profile_ftel['customer_type'].isin([None, 'Ca nhan', np.nan]) & profile_ftel['name'].notna()
    ...
    profile_ftel.loc[profile_ftel['customer_type'].isin([None, 'Ca nhan', np.nan]), 'name'] = profile_ftel['clean_name']
