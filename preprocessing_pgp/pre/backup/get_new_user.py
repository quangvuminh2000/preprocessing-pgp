...
PRE_PROFILE_PATH = '/data/fpt/ftel/cads/dep_solution/sa/dev/pre/{}.parquet/d={}'
PRE_NEW_PROFILE_PATH = '/data/fpt/ftel/cads/dep_solution/sa/dev/pre/{}_newcomer.parquet'
...
# FID_PATH = '/data/fpt/ftel/cads/dep_solution/sa/dev/fid/test/'
# CHECKPOINT_PATH = os.path.join(FID_PATH, 'checkpoint')

FID_PATH = '/data/fpt/ftel/cads/dep_solution/sa/dev/fid/'
CHECKPOINT_PATH = '/data/fpt/ftel/cads/dep_solution/sa/dev/checkpoint'
