...
def UnifyFtel(profile_internet: pd.DataFrame, n_cores: int = 1):
    # dict_trash = {
    ...
    #     profile_internet = profile_internet.rename(columns={'gender_enrich': 'gender'})
...
def UpdateUnifyFtel(now_str: str, n_cores: int = 1):
    # VARIABLES
