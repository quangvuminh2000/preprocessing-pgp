...
#                                  filesystem=hdfs, columns = ['ShopCode', 'LV1_NORM', 'LV2_NORM', 'LV3_NORM']).drop_duplicates()
    ...
    profile_location_fshop_bug =\
        profile_location_fshop_bug[['uid', 'address']]
    ...
    profile_location_fshop =\
        profile_location_fshop[
            ~profile_location_fshop['uid'].isin(
                profile_location_fshop_bug['uid'])
        ]
    ...
    profile_location_fshop = profile_location_fshop[~profile_location_fshop['uid'].isin(
        profile_location_fshop_bug['uid'])]
    profile_location_fshop = pd.concat([
        profile_location_fshop,
        profile_location_fshop_bug
