...
def UnifyLongChau(date_str: str, n_cores: int = 1):
    # VARIABLES
    ...
    profile_longchau = pd.read_parquet(
    ...
    profile_longchau["customer_type"] = profile_longchau[
        "customer_type"
    ...
    profile_location_longchau_bug = profile_location_longchau_bug.merge(
        latest_location_longchau, how="left", on=["uid"]
    )
    ...
    profile_location_longchau = profile_location_longchau.append(
        profile_location_longchau_bug, ignore_index=True
    )
    ...
    profile_location_longchau_bug = profile_location_longchau_bug.merge(
        temp_latest_location_longchau, how="left", on=["uid"]
    )
    profile_location_longchau = profile_location_longchau[
        ~profile_location_longchau["uid"].isin(
            profile_location_longchau_bug["uid"]
    ...
    profile_location_longchau_bug = profile_location_longchau_bug.merge(
        temp_latest_location_longchau, how="left", on=["uid", "district"]
    )
    profile_location_longchau = profile_location_longchau[
        ~profile_location_longchau["uid"].isin(
            profile_location_longchau_bug["uid"]
    ...
    profile_location_longchau_bug = profile_location_longchau_bug.merge(
        temp_latest_location_longchau, how="left", on=["uid", "city"]
    )
    profile_location_longchau = profile_location_longchau[
        ~profile_location_longchau["uid"].isin(
            profile_location_longchau_bug["uid"]
    ...
    profile_longchau.loc[
        profile_longchau["unit_address"].notna(), "source_unit_address"
    ] = "FSHOP from profile"
    ...
    profile_longchau["birthday"] = profile_longchau["birthday"].astype(
        "datetime64[s]"
    )
