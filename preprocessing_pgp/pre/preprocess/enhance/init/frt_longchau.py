...
def UnifyLongChau(
    ...
    profile_longchau = pd.read_parquet(f'{CENTRALIZE_PATH}/{f_group}.parquet/d={date_str}', filesystem=hdfs)
    # * Cleansing
    ...
    profile_longchau = profile_longchau[['uid', 'phone', 'email', 'name', 'gender', 'address', 'city', 'customer_type',]]
...
#                                     filesystem=hdfs, columns = ['ShopCode', 'level1_norm', 'level2_norm', 'level3_norm']).drop_duplicates()
    ...
    profile_location_longchau = profile_location_longchau.rename(columns={'cardcode': 'uid'})
    ...
    profile_location_longchau = profile_location_longchau.drop_duplicates(subset=['uid'], keep='first')
    ...
    latest_location_longchau = latest_location_longchau.rename(columns={'cardcode': 'uid'})
    ...
    profile_location_longchau_bug = profile_location_longchau_bug[['uid', 'address']].copy()
    profile_location_longchau_bug = profile_location_longchau_bug.merge(latest_location_longchau, how='left',
                                                                        on=['uid'])
    profile_location_longchau = profile_location_longchau[~profile_location_longchau['uid'].isin(profile_location_longchau_bug['uid'])]
    ...
    profile_location_longchau_bug = profile_location_longchau_bug.drop(columns=['city', 'source_city'])
    temp_latest_location_longchau = latest_location_longchau[['uid', 'district', 'city', 'source_city']]
    profile_location_longchau_bug = profile_location_longchau_bug.merge(temp_latest_location_longchau, how='left', 
                                                                        on=['uid', 'district'])
    profile_location_longchau = profile_location_longchau[~profile_location_longchau['uid'].isin(profile_location_longchau_bug['uid'])]
    profile_location_longchau = profile_location_longchau.append(profile_location_longchau_bug, 
    ...
    temp_latest_location_longchau = latest_location_longchau[['uid', 'city', 'district', 'source_district']]
    profile_location_longchau_bug = profile_location_longchau_bug.merge(temp_latest_location_longchau, how='left', 
                                                                        on=['uid', 'city'])
    profile_location_longchau = profile_location_longchau[~profile_location_longchau['uid'].isin(profile_location_longchau_bug['uid'])]
    profile_location_longchau = profile_location_longchau.append(profile_location_longchau_bug, 
    ...
    profile_longchau = profile_longchau.merge(profile_location_longchau, how='left', on=['uid', 'address'])
