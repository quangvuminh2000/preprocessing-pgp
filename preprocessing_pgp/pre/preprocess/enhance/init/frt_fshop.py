...
def UnifyFshop(
    ...
    # load profile fshop
    profile_fshop = pd.read_parquet(f'{CENTRALIZE_PATH}/{f_group}.parquet/d={date_str}', filesystem=hdfs)
    ...
    profile_fshop = profile_fshop[['uid', 'phone', 'email', 'name', 'gender', 'address', 'city', 'customer_type',]]
...
#                                  filesystem=hdfs, columns = ['ShopCode', 'LV1_NORM', 'LV2_NORM', 'LV3_NORM']).drop_duplicates()
    ...
    profile_location_fshop = profile_location_fshop.rename(columns={'cardcode': 'uid'})
    ...
    profile_location_fshop = profile_location_fshop.drop_duplicates(subset=['uid'], keep='first')
    ...
    latest_location_fshop = latest_location_fshop.rename(columns={'cardcode': 'uid'})
    ...
    profile_location_fshop_bug = profile_location_fshop_bug[['uid', 'address']].copy()
    profile_location_fshop_bug = profile_location_fshop_bug.merge(latest_location_fshop, how='left',
                                                                  on=['uid'])
    profile_location_fshop = profile_location_fshop[~profile_location_fshop['uid'].isin(profile_location_fshop_bug['uid'])]
    ...
    temp_latest_location_fshop = latest_location_fshop[['uid', 'city', 'source_city',
                                                        'district', 'source_district']]
    ...
    profile_location_fshop_bug = profile_location_fshop_bug.drop(columns=['city', 'source_city'])
    temp_latest_location_fshop = latest_location_fshop[['uid', 'district', 'city', 'source_city']]
    profile_location_fshop_bug = profile_location_fshop_bug.merge(temp_latest_location_fshop, how='left', 
                                                                  on=['uid', 'district'])
    profile_location_fshop = profile_location_fshop[~profile_location_fshop['uid'].isin(profile_location_fshop_bug['uid'])]
    profile_location_fshop = profile_location_fshop.append(profile_location_fshop_bug, 
    ...
    temp_latest_location_fshop = latest_location_fshop[['uid', 'city', 'district', 'source_district']]
    profile_location_fshop_bug = profile_location_fshop_bug.merge(temp_latest_location_fshop, how='left', 
                                                                  on=['uid', 'city'])
    profile_location_fshop = profile_location_fshop[~profile_location_fshop['uid'].isin(profile_location_fshop_bug['uid'])]
    profile_location_fshop = profile_location_fshop.append(profile_location_fshop_bug, 
    ...
    profile_fshop = profile_fshop.merge(profile_location_fshop, how='left', on=['uid', 'address'])
