...
def UpdateDictName(date_str):
    # LOAD DATA
    # dict name
    dict_name_cdp = pd.read_parquet(ROOT_PATH + '/utils/dict_name_latest.parquet', filesystem=hdfs)
    ...
    # SAVE DEV
    dict_name_cdp.to_parquet(ROOT_PATH + '/utils/dict_name_latest.parquet', filesystem=hdfs, index=False)
