...
def UpdateDictName(date_str):
    ...
    dict_name_cdp = pd.read_parquet(
        '/data/fpt/ftel/cads/dep_solution/sa/dev/utils/dict_name_latest.parquet', filesystem=hdfs)
    ...
    process_names = process_names[process_names['is_human'] == True][[
        'predict_name']].drop_duplicates()
    ...
    dict_name_cdp.to_parquet(
        '/data/fpt/ftel/cads/dep_solution/sa/dev/utils/dict_name_latest.parquet', filesystem=hdfs, index=False)
