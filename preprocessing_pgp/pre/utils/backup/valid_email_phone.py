...
def ValidPhoneEmail(date_str):
    ...
    #     raw_f_emails = check_valid_email(emails_bank.copy(), 'email')
        ...
        email_fo.loc[email_fo['name'].isna(
        ), 'name'] = email_fo['username_email']
        ...
        email_fplay['username_email'] = email_fplay['email'].str.split(
            '@').str[0]
        ...
        email_fplay['domain_email'] = email_fplay['email'].str.split(
            '@').str[1]
        ...
        stats_email['domain_email'] = stats_email['email'].str.split(
            '@').str[1]
        ...
        check_emails = final_stats_email[[
            'email', 'description', 'use']].copy()
