...
try:
    try:
        from vector_creation import load_vectorization_from_disk
    except ImportError:
        from scripts.train_script.vector_creation import load_vectorization_from_disk
except ImportError:
    from train_script.vector_creation import load_vectorization_from_disk
